...
`install.sh -a` now works out of the box on Raspbian/Debian 7.8 Wheezy, so you can run Mininet on a [Raspberry Pi](http://raspberrypi.org)! You can also install OVS 2.3.1 using "`install.sh -V 2.3.1`".
