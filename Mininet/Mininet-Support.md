...
<!-- %META:TOPICPARENT{name="Mininet-Learn-More"}% -->
...
Mininet is self-supported by the friendly Mininet community via the <code>mininet-discuss</code> mailing list and the [Mininet-FAQ](Mininet-FAQ). To sign up for the mailing list, go to https://mailman.stanford.edu/mailman/listinfo/mininet-discuss.
...
We also encourage you to contribute helpful questions and answers to the [Mininet-FAQ](Mininet-FAQ).
...
Older bugs are listed at [Mininet-Bugs](Mininet-Bugs) and feature requests at [Mininet-Feature-Requests](Mininet-Feature-Requests.md).
