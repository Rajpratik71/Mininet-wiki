...
* `camelCase` is used for method and variable names in preference to `under_scores`. This is intended to give class, method, and variable names a consistent look and to reduce cognitive load.
