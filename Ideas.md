...
### [Mininet Project Ideas](#wiki-mininet-project-ideas)

### [Background](#wiki-background)

### [Google Summer of Code Information](#wiki-google-summer-of-code-information)

### [Mininet Development Process](#wiki-mininet-development-process)

### [Making it Real: extending existing prototype code into an official feature](#wiki-making-it-real-extending-existing-prototype-code-into-an-official-feature)
* [Hardware interface support](#wiki-hardware-interface-support)
* [Access into Mininet from host and/or local network](#wiki-access-into-mininet-from-host-andor-local-network)
* [sshd support](#wiki-sshd-support)
* [Mininet GUIs: consoles.py and miniedit.py](#wiki-mininet-guis-consolespy-and-minieditpy)
* [Automatic NAT implementation](#wiki-automatic-nat-implementation)

### ["Easier" Projects](#wiki-easier-projects)
* [Mininet error checking and diagnostics/status monitoring](#wiki-mininet-error-checking-and-diagnosticsstatus-monitoring)
* [Better X11 support](#wiki-better-x11-support)
* [Easier VM image creation (e.g. using something like ubuntu-vm-builder)](#wiki-easier-vm-image-creation-eg-using-something-like-ubuntu-vm-builder)
* [Real API documentation explaining how to use the API (will be helped somewhat by integrating CS244 intro document)](#wiki-real-api-documentation-explaining-how-to-use-the-api-will-be-helped-somewhat-by-integrating-cs244-intro-document)
* [Automatic/easy update for Mininet (esp. in VM image)](#wiki-automaticeasy-update-for-mininet-esp-in-vm-image)
* [Additional easy (but non-critical)  bug fixes](#wiki-additional-easy-but-non-critical--bug-fixes)
* [Patch bay object](#wiki-patch-bay-object)
* [“testbed mode” - Hosts optionally on both control and data networks](#wiki-testbed-mode---hosts-optionally-on-both-control-and-data-networks)
* [Additional parametrized topologies (fat tree, jellyfish, mesh, random, etc.) bundled with easy controller support for multipath](#wiki-additional-parametrized-topologies-fat-tree-jellyfish-mesh-random-etc-bundled-with-easy-controller-support-for-multipath)
* [Raspberry Pi Mininet image/"network in a box" ;-)](#wiki-raspberry-pi-mininet-imagenetwork-in-a-box--)

### ["Advanced"/more challenging projects](#wiki-advancedmore-challenging-projects)
* [More sample, downloadable SDN systems (including controller and applications)](#wiki-more-sample-downloadable-sdn-systems-including-controller-and-applications)
* [Enhanced placement and documentation for Mininet examples](#wiki-enhanced-placement-and-documentation-for-mininet-examples)
* [Cluster mode - supporting execution over multiple machines (RemoteSwitch,L2TP/VDE/VXLAN/Capsulator, etc.)](#wiki-cluster-mode---supporting-execution-over-multiple-machines-remoteswitchl2tpvdevxlancapsulator-etc)
* [Hybrid network support (API for hardware, virtual and combo network tests)](#wiki-hybrid-network-support-api-for-hardware-virtual-and-combo-network-tests)
* [Seamless migration between Mininet and hardware](#wiki-seamless-migration-between-mininet-and-hardware)
* [Mininet control of real hardware](#wiki-mininet-control-of-real-hardware)
* [Automated deployment on EC2](#wiki-automated-deployment-on-ec2)
* [Automated deployment on other testbeds? (emulab, geni, etc.)](#wiki-automated-deployment-on-other-testbeds-emulab-geni-etc)
* [Automated creation of virtual network based on real network](#wiki-automated-creation-of-virtual-network-based-on-real-network)
* [Mininet network debugger (ndb)?](#wiki-mininet-network-debugger-ndb)
* [Code refactoring including Mininet core which could be used independently](#wiki-code-refactoring-including-mininet-core-which-could-be-used-independently)
* [Error recovery using Python's with statement (Mininet 3.0?)](#wiki-error-recovery-using-pythons-with-statement-mininet-30)
* [Measured scalability results (and possibly improved scalability)](#wiki-measured-scalability-results-and-possibly-improved-scalability)
* [Provisioning advice and/or automatic provisioning support](#wiki-provisioning-advice-andor-automatic-provisioning-support)
* [Integrated (emulator and emulated) performance monitoring](#wiki-integrated-emulator-and-emulated-performance-monitoring)
* [Mininet validation against hardware testbeds](#wiki-mininet-validation-against-hardware-testbeds)
* [Other OS support: Debian Wheezy, Fedora Core, BSD? OS X? Windows?](#wiki-other-os-support-debian-wheezy-fedora-core-bsd-os-x-windows)
* [Link (e.g. wire or wireless) simulator support](#wiki-link-eg-wire-or-wireless-simulator-support)
* [Ability to more compactly package Mininet networks and download into VM](#wiki-ability-to-more-compactly-package-mininet-networks-and-download-into-vm)
* ["Pure" Python implementation (need to determine the performance hit)](#wiki-pure-python-implementation-need-to-determine-the-performance-hit)
* [Enhanced unit tests](#wiki-enhanced-unit-tests)
* [Enhanced system tests](#wiki-enhanced-system-tests)
* [Automatic testing of examples/](#wiki-automatic-testing-of-examples)
* [Performance analysis and fixes to the Linux kernel and Open vSwitch](#wiki-performance-analysis-and-fixes-to-the-linux-kernel-and-open-vswitch)
* [Virtual time via time-dilation](#wiki-virtual-time-via-time-dilation)
* [Virtual time via barrier synchronization](#wiki-virtual-time-via-barrier-synchronization)
* [Different modes of operation to trade of emulation speed vs. performance accuracy](#wiki-different-modes-of-operation-to-trade-of-emulation-speed-vs-performance-accuracy)
* [Higher-performing switches (e.g. VALE-enabled OVS and/or custom switch)](#wiki-higher-performing-switches-eg-vale-enabled-ovs-andor-custom-switch)
* [Support for private /etc directory and possbly private filesystem, user space, PID space, etc.](#wiki-support-for-private-etc-directory-and-possbly-private-filesystem-user-space-pid-space-etc)
