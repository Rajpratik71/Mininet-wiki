Here is a page for information and links to the Mininet Projects for Google Summer of Code 2013, which were selected out of more than 20 applicants who usually based their projects on ideas from the Mininet [[ Project Ideas | Ideas ]] page. In addition to the pages listed below, we encourage discussion on `mininet-discuss` and also via GitHub pull requests. We may also create an IRC channel for all of the GSoC projects at onlab if people think that would be useful.
